...
public class library {
    ...
    static {
       ...
       listBooks.add(new Book("To Kill a Mockingbird", "Harper Lee", true));
    ...
    public static ArrayList<User> listUsers;
     static {
        ...
        listUsers.add(new Librarian("pass3","Jack","Smith","jack@email.com","125 Main St",1234567892));
        listUsers.add( new Librarian("pass4","Jill","Smith","jill@email.com","126 Main St",1234567893));
    }
